...
use ParkManager\Component\Acl\Resource\ObjectReference;

final class ObjectReferenceTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @test
     *
    ...
    public function it_can_accept_any_id($objectIdInput)
    {
        ...
        $objectId = new ObjectReference($module, $objectIdInput);
